...
export default function Navbar() {
  ...
  return (
    <nav className="w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-700 bg-[#F9FAFB] dark:bg-[#111827] transition-colors duration-300 font-space-gro">
